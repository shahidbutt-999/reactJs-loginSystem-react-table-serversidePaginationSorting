...
const HomeScreen = (props) => {
  ...
  return (
    <section id="home-screen" className="row">
      <div
        id="sidebar"
        className="col-12 col-md-2 d-flex flex-column flex-shrink-0 p-3 bg-dark"
      >
        <div className="d-flex justify-content-between align-items-center">
          <Link className="text-decoration-none text-white">HazelSoft</Link>
        ...
        >
          {data.map((e) => (
            <li className="nav-item" key={e.id}>
              <Link
                to={
                  e.name !== "Dashboard" ? "/adminpage/" + e.name : "/adminpage"
                }
